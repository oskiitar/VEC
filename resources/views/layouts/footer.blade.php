...
<footer class="pt-5 bg-secondary text-body">
    <div class="container d-flex">
        <div class="col">
            ...
            <p>
                Virtual Escape Coruña , el primer centro de Realidad Virtual de Galicia.
                En Virtual Escape Coruña ofrecemos las mejores experiencias del mercado en Realidad
                Virtual combinado con el escapismo tradicional.
            </p>
        </div>
        <div class="col">
            <h3>Datos de contacto</h3>
            <div>
                <label>VIRTUAL ESCAPE CORUÑA</label>
